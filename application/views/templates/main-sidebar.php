 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?= strtoupper(substr($data_user['nama_lengkap'], 0,10).' - '.$data_user['divisi'])?> </a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?= ($mm['url'] == $this->uri->segment(1,0) ? 'menu-open' : '') ?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url()?>auth/out" class="nav-link">
